...
/**
 * It will allow to use a Painter object as we do with a Java Graphics object
 * and it will do the work of translating your draw calls into Canvas draw calls
 *
